...
const docsPDF = [
  ...
  },
  {
    ...
    url:
      'https://ws199.juntadeandalucia.es/imgplan/NormaMarmolejoPlanCerro.pdf',
  },
  {
    nombre: 'Recomendaciones para prevenir riesgos',
    url:
      'https://ws199.juntadeandalucia.es/imgplan/RecomendacionesPlanCerro.pdf',
  },
  {
...
var errInesperado =
  'Ha ocurrido un error inesperado. Vuelva a ejecutar la aplicación'
var errCode = [2]
var errMsg = [
  'No es posible visualizar la ruta. El desplazamiento no se realiza en carreta',
]
var htmlAcercade = `<img src='img/logoJunta.png'/><br>Plan del Cerro<br>Versión ${appVersion}<br><br>Junta de Andalucía<br><a href='#' onclick='javascript:openInfo();'>Consejería de Presidencia, Administración Pública e Interior</a>`
function openInfo() {
  cordova.InAppBrowser.open(
    'https://www.juntadeandalucia.es/organismos/presidenciaadministracionpublicaeinterior.html',
    '_system'
  )
}
